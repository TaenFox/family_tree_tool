...
const primaryNameField = document.querySelector("#primary-name-field");
const maidenToggle = document.querySelector("#maiden-toggle");
const maidenNameField = document.querySelector("#maiden-name-field");
...
const deleteCardName = document.querySelector("#delete-card-name");
